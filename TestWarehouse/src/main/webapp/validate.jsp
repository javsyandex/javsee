    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="badge-important well well-small">
                <span class="label label-important"><h4>Ошибка!</h4></span>
                <c:forEach items="${prodErr}" var="ProdErr" >                   
                   <p><span class="label label-important">К сожалению <c:out value="${ProdErr}"/> на <c:out value="${ProdErr}"/> поступлений товара <c:out value="${ProdErr}"/> не было!</span></p>
                </c:forEach>
                   <p><span class="label label-important">К сожалению <c:out value="${ProdErr}"/> на <c:out value="${ProdErr}"/> поступлений товара <c:out value="${ProdErr}"/> не было!</span></p>
            </div> 
